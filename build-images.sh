...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/redis:7.4.5-alpine docker.io/mariadb:10.11.14 docker.io/nginx:1.29.2-alpine ghcr.io/nethserver/nextcloud-app:${IMAGETAG} ghcr.io/nethserver/nextcloud-notify_push:${IMAGETAG}" \
    "${container}"
# Commit the image

...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/redis:7.4.5-alpine docker.io/mariadb:10.6.22 docker.io/nginx:1.29.1-alpine ghcr.io/nethserver/nextcloud-app:${IMAGETAG} ghcr.io/nethserver/nextcloud-notify_push:${IMAGETAG}" \
    "${container}"
# Commit the image

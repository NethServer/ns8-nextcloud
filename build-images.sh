...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/redis:6.2.17-alpine docker.io/mariadb:11.7.2 docker.io/nginx:1.27.3-alpine ghcr.io/nethserver/nextcloud-app:${IMAGETAG}" \
    "${container}"
# Commit the image

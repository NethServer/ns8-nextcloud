...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/redis:7.4.2-alpine docker.io/mariadb:10.6.21 docker.io/nginx:1.27.3-alpine ghcr.io/nethserver/nextcloud-app:${IMAGETAG}" \
    "${container}"
# Commit the image
